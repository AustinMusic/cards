...
if(isset($_POST['forgotSubmit'])){
    ...
    if(!empty($_POST['emailaddress'])){
        ...
        $prevCon['where'] = array('emailaddress'=>$_POST['emailaddress']);
        ...
        if($prevUser > 0){
            ...
            if($update){
                $resetPassLink = 'http://www.l3valuation.com/cards/resetPassword.php?fp_code='.$uniqidStr;
                
                //get user details
                $con['where'] = array('emailaddress'=>$_POST['emailaddress']);
                ...
                <br/><br/>Regards,
                <br/>Michael Martino
                <br/>CARDS System Administrato';
                //set content-type header for sending HTML email
                $headers = "MIME-Version: 1.0" . "\r\n";
                $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
                //additional headers
                $headers .= 'From: Michael Martino<mmartino@l3valuation.com>' . "\r\n";
                //send email
            ...
            $sessData['status']['type'] = 'error';
            $sessData['status']['msg'] = 'The entered email is not associated with any account.'; 
        }
