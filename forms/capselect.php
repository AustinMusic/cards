...
$xml = file_get_contents( $_SERVER[ 'DOCUMENT_ROOT' ] . "/cards/forms/CaprateSearchFields.xml" );
...
<body>
	<div class="mainpage">
		...
		<a class="btn" id='addSelectedLinesBtn' style='display:none; clear:both; width: 200px;'>Add Cap Rate(s)</a><br />
				...
				<table width="100%" border="1" id="comps" class="display table _table">
					<thead>
						<tr>
							...
							<th style="width: 150px;">Property Name<br>Address</th>
							<th style="width: 100px;">City<br>Submarket</th>
							<th style="width: 100px;">Property Type<br>Subtype</th>
							<th style="width: 80px;text-align:center">Year Built<br>(Renovated)</th>
							<th style="width: 100px;text-align:center">Total GBA (SF)<br>Const. Desc.</th>
							<th style="text-align:center">Parking Ratio<br>&#35; of Stories</th>
							<th style="width: 100px;text-align:center">Record Date<br>Sale Status</th>
	...
	<script type='text/javascript'>
		...
		$( document ).ready( function () {
			...
			aa_searchEngine = new _aa_searchEngine( {
				...
				//selectionsElement: "caprateIDs",
				reportTypeID: [ 2 ],
				defaultSchemes: searchSchemes,
				gridType: "caprate",
				gridRowTPL: "gridRowCaprateTPL",
				renderMap: true,
				useStreetView: false,
				wopener: {
	...
	<div id="gridRowCaprateTPL" style='display:none;'>
		<!--
	...
	<td class='selectable' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>propertyname_proxy<br>address_proxy</font></td>
	<td class='selectable' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>city_proxy<br>submarket_proxy</font></td>	
	<td class='selectable' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>property_type_proxy<br>subtype_proxy</font></td>
	<td class='selectable' align='center' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>year_built_proxy<br>last_renovation_proxy</font></td>
	<td class='selectable' align='center' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>overall_gba_proxy<br>const_descr_proxy</font></td>
	<td class='selectable' align='center' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;'><font family='Calibri' size='2'>parking_ratio_proxy<br>no_stories_proxy</font></td>
	<td class='selectable' align='center'><font family='Calibri' size='2'>record_date_proxy<br>sale_status_proxy</font></td>
	<td class='selectable' align='center'><font family='Calibri' size='2'>adj_price_sf_nra_proxy</font></td>
	<td class='selectable' align='center'><font family='Calibri' size='2'>ind_pct_office_proxy</font></td>
	<td class='selectable' align='center'><font family='Calibri' size='2'>adj_price_unit_proxy</font></td>
	<td class='selectable' align='center'><font family='Calibri' size='2'>site_cover_primary_proxy</font></td>
	<td class='selectable' align='center'><font family='Calibri' size='2'>cap_rate_proxy</font></td>
	!-->
	</div>
