...
$xml = file_get_contents($_SERVER['DOCUMENT_ROOT']."/cards/forms/AddLeaseSearchFields.xml");
...
<body>
	<div class="mainpage">
		...
		<a class="btn" id='addSelectedLinesBtn' style='display:none; clear:both; width: 200px;'>Add Lease(s)</a><br />
				...
				<table width="100%" border="1" id="comps" class="display table _table">
					<thead>
						<tr>
							...
							<th style="width: 80px;">City<br>Submarket</th>
							<th style="width: 80px;">Property Type<br>Subtype</th>
							<th style="text-align:center">Year Built<br>(Renovated)</th>
							<th style="text-align:center">Overall GBA (SF)<br>Const. Desc.</th>
							<th>Start Date<br>Lessee Name</th>
							<th style="text-align:center">Tenant<br>Area (SF)</th>
							<th style="text-align:center">Exp. Terms<br>Adjust. To</th>
							<th style="text-align:center">Eff. Rent<br>SF / Mo<br>Shell / Office</th>
							<th style="text-align:center">Eff. Rent<br>SF / Mo<br>Blended</th>    
	...
	<script type='text/javascript'>
		...
		$( document ).ready( function () {
			...
			aa_searchEngine = new _aa_searchEngine({
				...
				//selectionsElement:"leaseIDs",
				reportTypeID: [3],
				defaultSchemes: searchSchemes,
				gridType: "xtrarents",
				gridRowTPL: "gridRowxtrarentsTPL",
				renderMap: true,
				useStreetView: false,
				wopener:{
					container:"xtrarents_table",
					idsInput: "xtrarentsIDs",
					cellClasses:["selectable","","selectable cellNoWrap","selectable cellNoWrap","selectable cellNoWrap","selectable cellNoWrap cellAlignCenter","selectable cellNoWrap cellAlignCenter","selectable cellNoWrap","selectable cellNoWrap cellAlignCenter","selectable cellNoWrap cellAlignCenter","selectable cellNoWrap cellAlignCenter","selectable cellNoWrap cellAlignCenter","selectable cellNoWrap cellAlignCenter"],
					cellMethods: ["indexCounter",["photo1","thumbnail"],["property_name","address"],["city","submarket"],["property_type","subtype"],["year_built","last_renovation"],["overall_gba","const_descr"],["lease_start_date","lessee_name"],"tenant_area_sf",["lease_expense_term","exp_term_adj"],["eff_rent_sf_mo_shell","eff_rent_sf_mo_office"],"eff_rent_sf_mo_blend","eff_rent_sf_yr"]
				}
			});
			aa_searchEngine.init();
		} );
	</script>
	<div id="gridRowxtrarentsTPL" style='display:none;'>
	<!--
	...
	<td style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>property_type_proxy<br>subtype_proxy</font></td>
	...
	<td style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;' align='center'><font family='Calibri' size='2'>overall_gba_proxy<br>const_descr_proxy</font></td>
	...
	<td align='center'><font family='Calibri' size='2'>lease_expense_term_proxy<br>exp_term_adj_proxy</font></td>
