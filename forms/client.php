...
require( "../admin/classes/client.php" );
require( "classes/dataSourceController.php" );
require( "../admin/classes/clientDBController.php" );
...
if ( isset( $_POST[ 'submit' ] ) ) {
    ...
    if ( $client->getCompname() == "" ) {
        ...
        $clientDBController = new clientDBController();
        $clientDBController->db = $db;	
		$clientData = $clientDBController->getTableRecord($client->getId());
		
		$_GET['id'] = $client->getId();
    }
