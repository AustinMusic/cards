...
<body>
	<div class="mainpage">
		...
		<a class="btn" id='addSelectedLinesBtn' style='display:none; clear:both; width: 200px;'>Add Improved Sale(s)</a><br />
	...
	<script type='text/javascript'>
		...
		$( document ).ready( function () {
			...
			aa_searchEngine = new _aa_searchEngine( {
				...
				//selectionsElement: "improvedIDs",
				reportTypeID: [ 2 ],
				defaultSchemes: searchSchemes,
				gridType: "improved_sales",
				gridRowTPL: "gridRowImprovedSalesTPL",
				renderMap: true,
				useStreetView: false,
				wopener: {
					container: "improved_sales_table",
					idsInput: "improved_salesIDs",
