...
if(isset($_POST['submit'])){
    ...
    $appraisals->setSfbedroom(str_replace(',','', $_POST['sfbedroom']));
    $appraisals->setSffullbath(str_replace(',','', $_POST['sffullbath']));
    $appraisals->setSfhalfbath(str_replace(',','', $_POST['sfhalfbath']));
...
require("templates/templateAppraisals.php");
