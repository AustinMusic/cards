...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAtTb5qzQ9x50dKqqkfNrrypXRFYkw91NQ&amp;v=3&amp;libraries=places" async defer></script> 
      ...
      <div id="Leases_main">
        <div class="formheader">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#fileinformation4" role="tab"><i class="fa fa-folder-o" aria-hidden="true"></i> File Information</a> </li>
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#location" role="tab">Leases</a> </li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#transaction" role="tab">Transaction Data</a> </li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#rental" role="tab">Rental Data</a> </li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#rentalMf" id="multFamTab" role="tab">Multi Family</a> </li>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ministorage" id="MinStoreTab" role="tab">Mini Storage</a> </li>
					<?php if($login_ro == 0) { ?>
            <li class="nav-item"><a class="nav-link _selectTab" data-toggle="tab" href="#addphotos" role="tab">Additional Photos</a> </li>
          </ul>
          <ul class="nav nav-tabs" id="reportSave">
            <li class="nav-item">
        ...
        <div class="tab-content"> 
              ...
              <div class="col-4 groupsection">
                ...
                <div class="fieldsareawhead label125">
                  <div class="form-group row">
                    <label>Status:</label>
                    <select class="form-control _formUpdate" name="status">
                      <?php
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control _formUpdate" name="priority">
                      <?php
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control _formUpdate" name="AssignedTo">
                      <?php
              ...
              <div class="col-4 groupsection">
                ...
                <div class="fieldsareawhead label125">
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control _formUpdate" name="template" id="_exportlsTemplate">
                      <?php
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control _formUpdate" id="type">
              ...
              <div class="col-4 groupsection">
                ...
                <div class="fieldsareawhead label100">
                  <div class="form-group row">
                    ...
                    <font style="font-size: 0.875rem; line-height: 35px;"> <?php echo $leases->getDateCreated(); ?> </font> </div>
                  <div class="form-group row">
                    <label>Created By:</label>
                    <font style="font-size: 0.875rem; line-height: 35px;"> <?php echo $leases->getCreatedBy(); ?> </font> </div>
                  <div class="form-group row">
                    <label>Date Modified:</label>
                    <font style="font-size: 0.875rem; line-height: 35px;"> <?php echo $leases->getDateModified(); ?> </font> </div>
                  <div class="form-group row">
                    <label>Modified By:</label>
                    <font style="font-size: 0.875rem; line-height: 35px;"> <?php echo $leases->getModifiedBy(); ?> </font> </div>
					<div class="form-group row">
                    <label>File Origin:</label>
						<?php if($leases->getFileOrigin() == 'Original File') { ?>
                    <font style="font-size: 0.875rem; line-height: 35px;"> <?php echo $leases->getFileOrigin(); ?> </font> <?php } else {
						?>
					<font style="font-size: 0.875rem; line-height: 35px;"><a href='<?php echo $leases->getClonelink(); ?>' target="_blank"><?php echo $leases->getFileOrigin(); ?></a>  </font>	
					<?php } ?> </div>
                </div>
              </div>
            </div>
          ...
          <div id="location" class="tab-pane active" role="tabpanel">
            <div class="grouprow">
              <div class="col-3 groupsection label100">
                ...
                <div class="fieldsareawhead label125">
                  <div class="section-inner-width imgPlc" id="subjectPhoto">
					...
					<?php if($login_ro == 0) { ?>
                    <div class='preview-sp1-panel'>
                      <a style='padding:4px; cursor:pointer; font-size: 24px;' class='fa fa-camera img-edit' data-rel-photo-btn='sp1' data-container='subjectPhoto'/></a>
                      <?php if ($leases->getPhoto1() != '') { ?>
                      <a style='padding:4px; cursor:pointer; font-size: 24px;' class='fa fa-trash img-del' data-rel-photo-btn='sp1' data-container='subjectPhoto'/></a>
                      <?php } ?> </div>
					<?php } ?>
                </div>
              </div>
              <div class="col-6 groupsection label125" style="margin-bottom: 0px;">
                <div class="fieldsarea">
                  ...
                  <div class="col-6 groupsection padding-0" style="float: right">
                    <div class="form-group row">
                      ...
                      <select class="form-control _formUpdate _bms20field" name="propertytype" id='selectPropertType'>
                        <?php
                    ...
                    <div class="form-group row">
                      ...
                      <select class="form-control _formUpdate _bmsfield" name="propertysubtype" id='selectSubPropertType'>
                        <?php
                    ...
                    <div class="form-group row _mobhomeShow">
                      ...
                      <select class="form-control _formUpdate _bms3field" name="park_type">
                        <?php
                    ...
                    <div class="form-group row">
                      ...
                      <select class="form-control _formUpdate" name="genmarket" id="selectMarketArea">
                        <?php
                    ...
                    <div class="form-group row">
                      ...
                      <select class="form-control _formUpdate" name="submarkid" id="selectSubMarketArea">
                        <?php
              ...
              <div class="form-group row">
                ...
                <input type="checkbox" name="emdomain" class="form-control checkbox" id="emdomain" value="1" <?php if ($leases->getEmdomain()==1 ) echo 'checked="checked"'; ?> />
              </div>
            ...
            <div class="col-12 padding-0">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#street_traffic" role="tab">Street/Traffic</a> </li>
              </ul>
              <div class="tab-content inner-tab-content">
                <div id="street_traffic" class="tab-pane active">
                  <div class="grouprow">
              ...
              <div class="col-12 groupsection label125">
                <div class="fieldsarea">
                  <div class="form-group row" style="width: 20%;float: left;">
                    ...
                    <input type="checkbox" name="property_appraised" class="form-control checkbox" id="propapp" value="1" <?php if ($leases->getProperty_appraised()==1 ) echo 'checked="checked"'; ?>/>
                  </div>
              ...
              <div class="col-4 groupsection label150 padding-0">
                <div class="fieldsarea">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="checkbox" name="conf_lessee" class="form-control checkbox" id="confless" value="1" <?php if ($leases->getConf_lessee() == 1) echo 'checked="checked"'; ?> />
                  </div>
              ...
              <div class="col-4 groupsection label190 padding-0">
                <div class="fieldsarea">
                  <div class="form-group row">
                    ...
                    <select class="form-control _bms3field" name="new_renewal">
                      <?php
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="lessee_type">
                      <?php
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="lease_options" id="lease_options">
                      <?php
                ...
                <div class="fieldsarea">
                  ...
                  <div class="row" style="margin: 0px;">
                    ...
                    <div class="form-group row" style="width: 24%; float: right;">
                      <select class="form-control" style="width: 100%" name="mos_vs_mos">
                        <?php
                ...
                <div class="fieldsarea">
                  ...
                  <div class="col-xs-12 col-sm-12 padding-0">
                    ...
                    <div class="form-group row rowconf">
                      ...
                      <select class="form-control _bms1field" name="confirm1">
                        <?php
                    ...
                    <div class="form-group row rowconf">
                      ...
                      <select class="form-control _bms1field" name="confirm2">
                        <?php
                        for ( $s = 0; $s < count( $appraisers ); $s++ ) {
                          ?>
                        <option value='<?php echo $appraisers[$s]["id"]; ?>' <?php
                    ...
                    <div class="form-group row">
                      ...
                      <select class="form-control" name="inspect_type">
                        <?php
          ...
          <div id="rental" class="tab-pane fade">
              ...
              <div class="col-3 groupsection label225 padding-0">
                <div class="fieldsarea">
                  <div class="form-group row">
                    ...
                    <input type="checkbox" name="showabsorb1" class="form-control checkbox" value="1" id="showAbsorb" <?php if ($leases->getShowabsorb1() ==1 ) echo 'checked="checked"'; ?> />
                  </div>
                </div>
              </div>
              <div class="col-3 groupsection label225 padding-0">
                <div class="fieldsarea">
                  <div class="form-group row">
                    ...
                    <input type="checkbox" name="showyard" class="form-control checkbox" value="1" id="showYard" <?php if ($leases->getShowyard() ==1 ) echo 'checked="checked"'; ?> />
                  </div>
                </div>
              </div>
              <div class="col-3 groupsection label225 padding-0">
                <div class="fieldsarea">
                  <div class="form-group row">
                    ...
                    <input type="checkbox" name="showor"class="form-control checkbox"  value="1" id="showOtherRent" <?php if ($leases->getShowor() ==1 ) echo 'checked="checked"'; ?> />
                  </div>
                </div>
              </div>
              <div class="col-3 groupsection label225 padding-0">
                <div class="fieldsarea">
                  <div class="form-group row">
                    ...
                    <input type="checkbox" name="show_land_bldg" class="form-control checkbox" value="1" id="showLBRent" <?php if ($leases->getShow_land_bldg() ==1 ) echo 'checked="checked"'; ?> />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 padding-0">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#generalprojectdata" role="tab">General Project Data</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#demisedspacedata" id="demSpaceTab" role="tab">Demised Space Data</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#spaceleaseeconomics" id="spLeaseEcoTab" role="tab">Space Lease Economics</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#yardlease" id="yardLeaseTab" role="tab">Yard Lease</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#otherrents" id="otherRentsTab" role="tab">Other Rents</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#projectabsorptiondata" id="projAbsorbTab" role="tab">Project Absorption Data</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#landbldgrentanalysics" id="LandBldgTab" role="tab">Land / Bldg. Rent Analysics</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#comments" role="tab">Comments</a> </li>
              </ul>
              <div class="tab-content inner-tab-content">
                <div id="generalprojectdata" class="tab-pane active">
                  <div class="grouprow">
                    ...
                    <div class="col-3 groupsection label190 padding-0" id="PropDataTab">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          ...
                          <input type="checkbox" name="proj_site" class="form-control checkbox" id="projsite" value="1" <?php if ($leases->getProj_site() ==1 ) echo 'checked="checked"'; ?> />
                        </div>
...
<!--                        <div class="form-group row">
                          <label>Year(s) Built - SEARCH</label>
                          <input type="number" step="1" class="form-control _formUpdate" name="year_built_search" value="<?php echo $leases->getYear_built_search(); ?>"/>
                        </div>-->
                        <div class="form-group row">
                        ...
                        <div class="form-group row _hideMFProp">
                          ...
                          <select class="form-control _formUpdate _bms3field" name="occupancy_type">
                            <?php
                    ...
                    <div class="col-3 groupsection label150 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row _mobhome">
                          ...
                          <select class="form-control _formUpdate _bms3field" name="building_quality">
                            <?php
                        ...
                        <div class="form-group row _mobhome">
                          ...
                          <select class="form-control _formUpdate _bms3field" name="int_condition">
                            <?php
                            for ( $s = 0; $s < count( $conditionData ); $s++ ) {
                              ?>
                        ...
                        <div class="form-group row _mobhome">
                          ...
                          <select class="form-control _formUpdate _bms3field" name="ext_condition">
                            <?php
                            for ( $s = 0; $s < count( $conditionData ); $s++ ) {
                              ?>
                        ...
                        <div class="form-group row _mobhomeShow">
                          ...
                          <select class="form-control _bms3field" name="park_quality">
                            <?php
                            for ( $s = 0; $s < count( $conditionData ); $s++ ) {
                              ?>
                        ...
                        <div class="form-group row _mobhomeShow">
                          ...
                          <select class="form-control _bms3field" name="park_cond">
                            <?php
                            for ( $s = 0; $s < count( $conditionData ); $s++ ) {
                              ?>
                        ...
                        <div class="form-group row _hideMFProp">
                          ...
                          <select class="form-control _formUpdate _bms3field" name="exposure">
                            <?php
                        ...
                        <div class="form-group row _hideMFProp">
                          ...
                          <select class="form-control _formUpdate _bms3field" name="site_access">
                            <?php
                        ...
                        <div class="form-group row _mobhome">
                          ...
                          <select class="form-control _bms3field" name="off_fire_sprinkler">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
                ...
                <div id="demisedspacedata" class="tab-pane fade">
                  <div class="grouprow">
                    <div class="col-6 groupsection label175 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                    ...
                    <div class="col-6 groupsection label175 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          ...
                          <select class="form-control _bms3field" name="space_generation">
                            <?php
                        ...
                        <div class="form-group row IndOffhide">
                          ...
                          <select class="form-control _bms3field" name="space_position">
                            <?php
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#industrialdata" role="tab">Industrial Data</a> </li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#officedata" role="tab">Office Data</a> </li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#retaildata" role="tab">Retail Data</a> </li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#vehiclerelateddata" id="vehRelateTab" role="tab">Vehicle Related Data</a> </li>
                  </ul>
                  <div class="tab-content inner-tab-content">
                    <div id="industrialdata" class="tab-pane active">
                      <div class="grouprow">
                        ...
                        <div class="col-6 groupsection label150 padding-0">
                          <div class="fieldsarea">
                            <div class="form-group row">
                              ...
                              <select class="form-control _bms3field" name="ind_rail">
                                <?php
                                for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                  ?>
                    ...
                    <div id="officedata" class="tab-pane fade">
                      <div class="grouprow">
                        <div class="col-4 groupsection label150 padding-0">
                          <div class="fieldsarea">
                            <div class="form-group row">
                              <label>Building Class</label>
                              <select class="form-control _formUpdate _bms3field" name="building_class">
                                <?php
                        ...
                        <div class="col-4 groupsection label150 padding-0">
                          <div class="fieldsarea">
                            <div class="form-group row">
                              ...
                              <select class="form-control _bms3field" name="off_elevator_service">
                                <?php
                                for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                  ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"];?> </option>
                        ...
                        <div class="col-4 groupsection label190 padding-0">
                          <div class="fieldsarea">
                            <div class="form-group row">
                              <label>Full HVAC or Heating Only?</label>
                    ...
                    <div id="retaildata" class="tab-pane fade">
                      <div class="grouprow">
                        <div class="col-6 groupsection label150 padding-0">
                          <div class="fieldsarea">
                            <div class="form-group row">
                            ...
                            <div class="form-group row showRest">
                            ...
                            <div class="form-group row showRest">
                              ...
                              <select class="form-control" name="rest_drive_thru">
                                <?php
                                for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                  ?>
                        ...
                        <div class="col-6 groupsection label150 padding-0">
                          <div class="fieldsarea">
                            ...
                            <div class="form-group row showRest">
                              ...
                              <select class="form-control" name="rest_alcohol">
                                <?php
                                for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                  ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"];?> </option>
                            ...
                            <div class="form-group row showRest">
                              ...
                              <select class="form-control" name="rest_playground">
                                <?php
                                for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                  ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"];?> </option>
                    ...
                    <div id="vehiclerelateddata" class="tab-pane fade">
                      <div class="grouprow">
                        <div class="col-12 groupsection label150 padding-0">
                          <div class="fieldsarea">
                            <div class="form-group row">
                              <label>Level of Service</label>
                              <select class="form-control _bms3field" name="veh_level">
                                <?php
                    ...
                    <div class="col-6 groupsection label175 hideSS padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          ...
                          <select class="form-control _bms3field" name="lease_expense_term">
                            <?php
...
?> > <?php echo $leaseexptermData[$s]["definition"];?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control _bms3field" name="exp_term_adj">
                            <?php
...
?> > <?php echo $leaseexpadjData[$s]["definition"];?> </option>
                  ...
                  <div class="grouprow">
                    ...
                    <div class="col-6 groupsection label225  hideSS padding-0">
                      <div class="fieldsarea">
                    ...
                    <div class="col-4 groupsection label205 padding-0">
                      <div class="fieldsarea">
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="yard_lease_exp_term">
                            <?php
                            for ( $s = 0; $s < count( $leaseexptermData ); $s++ ) {
                              ?>
...
?> > <?php echo $leaseexptermData[$s]["definition"];?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="yard_exp_terms_adj">
                            <?php
                            for ( $s = 0; $s < count( $leaseexpadjData ); $s++ ) {
                              ?>
                    ...
                    <div class="col-4 groupsection label225 padding-0">
                      <div class="fieldsarea">
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="ortypes">
                            <?php
...
?> > <?php echo $ortypesData[$s]["definition"];?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="or_lease_exp_term">
                            <?php
...
?> > <?php echo $or_lease_exp_termData[$s]["definition"];?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="or_exp_terms_adj">
                            <?php
...
?> > <?php echo $or_exp_terms_adjData[$s]["definition"];?> </option>
          ...
          <div id="rentalMf" class="tab-pane fade">
              ...
              <div class="col-12 groupsection label175 padding-0">
                <div class="fieldsarea">
                  <div class="form-group row">
                    ...
                    <input type="checkbox" name="mf_show_absorbtion" class="form-control checkbox" id="showMFAbsorb" value="1" <?php if ($leases->getMf_show_absorbtion() ==1 ) echo 'checked="checked"'; ?> />
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xs-12 padding-5">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#generalpropertydata" role="tab">General Property Data</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#amenitiesunilities" role="tab">Amenities &amp; Utilities</a> </li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#unitabsorption" id="UnitAbsorb" role="tab">Unit Absorption</a> </li>
              </ul>
              <div class="tab-content inner-tab-content">
                <div id="generalpropertydata" class="tab-pane active">
                  <div class="grouprow">
                    <div class="col-3 groupsection label175 padding-0 _mobhome">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          <label>Parking Type</label>
                          <select class="form-control" name="mf_parking_type">
                            <?php
...
?> > <?php echo $parkingtypeData[$s]["definition"];?> </option>
                ...
                <div id="unitabsorption" class="tab-pane fade">
                  <div class="grouprow">
                    <div class="col-3 groupsection label175 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                ...
                <div id="amenitiesunilities" class="tab-pane fade">
                  <div class="grouprow">
                      ...
                      <div class="fieldsareawhead label125">
                        <div style="width: 49%; float: left;">
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_exercise">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            <label>Spa?</label>
                            <select class="form-control" name="mf_spa">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_club">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            <label>Playground?</label>
                            <select class="form-control" name="mf_playg">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_bbq">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_bigtv">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            <label>Shed?</label>
                            <select class="form-control" name="mf_shed">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div style="width: 49%; float: right;">
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_sports">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_laund">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            <label>Pool?</label>
                            <select class="form-control" name="mf_pool">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_busi">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_sec">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            <label>Carport?</label>
                            <select class="form-control" name="mf_carport">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
                      ...
                      <div class="fieldsareawhead label175">
                        <div style="width: 49%; float: left;">
                          <div class="form-group row _mobhome">
                            ...
                            <select class="form-control" name="mf_wd_hookup">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_washdry">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_fireplace">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_micro">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_patio">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_dish">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_dispo">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div style="width: 49%; float: right;">
                          <div class="form-group row">
                            <label>Sauna?</label>
                            <select class="form-control" name="mf_sauna">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_rvstor">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_vault">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control" name="mf_exstor">
                              <?php
                              for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                                ?>
                    ...
                    <div class="col-4 groupsection label175 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_rpt">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_insurance">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_cam">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_mgmt_fees">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
                    ...
                    <div class="col-4 groupsection label175 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_water">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_sewer">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_hot_water">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_heat">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
                    ...
                    <div class="col-4 groupsection label150 padding-0">
                      <div class="fieldsarea">
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_gas">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_trash">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_internet">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                        ...
                        <div class="form-group row">
                          ...
                          <select class="form-control" name="mf_landlord_cable">
                            <?php
                            for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                              ?>
              ...
              <div class="col-3 groupsection label150 padding-0">
                <div class="fieldsarea">
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="ms_coded_access">
                      <?php
                      for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                        ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="ms_onsite_mgr">
                      <?php
                      for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                        ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="ms_manager_res">
                      <?php
...
?> > <?php echo $mgrresdetailData[$s]["definition"]; ?> </option>
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="ms_alarm">
                      <?php
                      for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                        ?>
...
?> > <?php echo $yesnoDataDesc[$s]["definition"]; ?> </option>
                  ...
                  <div class="form-group row">
                    ...
                    <select class="form-control" name="ms_heated_unit">
                      <?php
                      for ( $s = 0; $s < count( $yesnoDataDesc ); $s++ ) {
                        ?>
                  ...
                  <div class="gallery" id="galleryContainer">
                    ...
                    <div class="remove galleryItem imgPlc" style='position:relative;' >
                      ...
                      <div class="caption-box">
                        ...
                        <div class='preview-sp1-panel'><a style='padding:4px; cursor:pointer; font-size: 20px;' class='fa fa-trash img-del' data-rel-photo-btn='sp1' data-container='imggal_<?php echo $proppics[$u]['id']; ?>'/></a></div>
                    </div>
                    <?php
                    }
                    }
