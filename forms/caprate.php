...
//        header("location: _improvedsales.php?id=". $improvedsales->getId());	
		$improvedSalesDBController = new improvedSalesDBController();
        $improvedSalesDBController->db = $db;	
		$caprateData = $improvedSalesDBController->getTableRecord($improvedsales->getId());
		
		$_GET['id'] = $improvedsales->getId();
	}
}
...
require("templates/templateImpComp.php");
