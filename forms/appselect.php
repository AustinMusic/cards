...
<?php $title = 'Admin - Appraisers' ?>
<?php $tablename = 'appraisers' ?>
<!doctype html>
<html>
...
$tables = array();
if(is_file($_SERVER[ 'DOCUMENT_ROOT' ] . "/cards/forms/AppraiserFields.xml")){
	$xml = file_get_contents( $_SERVER[ 'DOCUMENT_ROOT' ] . "/cards/forms/AppraiserFields.xml" );
...
?>
	<div class="mainpage">
		...
		<a class="btn" id='addSelectedLinesBtn' style='display:none; clear:both; width: 200px;'>Add Appraiser(s)</a><br />
	...
	<script type='text/javascript'>
		...
		$( document ).ready( function () {
			...
			aa_searchEngine = new _aa_searchEngine( {
				...
				//selectionsElement: "appraiserIDs",
				reportTypeID: [ 0 ],
				ajaxURL: "forms/ajax_appraisers.php",
				defaultSchemes: searchSchemes,
				gridType: "appraiser",
				gridRowTPL: "gridRowAppraiserTPL",
				wopener: {
					container: "appraiser_table",
					idsInput: "appraiserIDs",
	...
	<div id="gridRowAppraiserTPL" style='display:none;'>
		<!--
		...
		<td class='selectable' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>apptitle_proxy</font></td>	
		<td class='selectable' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>firstname_proxy</font></td>
		<td class='selectable' align='center' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>lastname_proxy</font></td>
		<td class='selectable' align='center' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;max-width:1px;'><font family='Calibri' size='2'>designation_proxy</font></td>
		<td class='selectable' align='center' style='white-space: nowrap; text-overflow:ellipsis; overflow: hidden;'><font family='Calibri' size='2'>emailaddress_proxy</font></td>
		<td class='selectable' align='center'><font family='Calibri' size='2'>phoneone_proxy</font></td>
		!-->
	</div>
</body>
