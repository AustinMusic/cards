...
class appraisalsDBController{
    ...
    public function getRecord($id){
        ...
        $sql_fields[] = APPRAISALS_TABLE.".appraiserone";
        $sql_fields[] = APPRAISALS_TABLE.".appraisertwo";
        $sql_fields[] = APPRAISALS_TABLE.".appasstone";
        $sql_fields[] = APPRAISALS_TABLE.".appassttwo";
        ...
        $sql_fields[] = APPRAISALS_TABLE.".adddartemplate";
        ...
        $sql_fields[] = APPRAISALS_TABLE.".addrentwordtemp";
        $sql_fields[] = APPRAISALS_TABLE.".addrentextemp";
        $sql_fields[] = APPRAISALS_TABLE.".miscrent_db";
        $sql_fields[] = APPRAISALS_TABLE.".xtrarents";
    ...
    public function appraisalsOperation($appraisals,$user_id){
        ...
        try{
            ...
            if($actionMode=="INSERT"){
                $stmt = $this->db->prepare("INSERT INTO ".APPRAISALS_TABLE." (FK_ReportID, job_no, bid_fee, appraisal_type, purpose_of_appraisal, client_name, client_reference_no, borrower, estate_appraised, prosstab_est_app, proscomp_est_app, as_is, prospective_stabilized, prospective_completion, retrospective, eff_date_value, prosstab_dov, proscomp_dov, retro_dov, inspect_date, site_valuation, cost_approach, income_approach, groundlease, sales_comparison, ownaddress, owncity, ownstate, ownzipcode, rowprojname, reqinsdate, rowdold, rowsfacq, rowappfirm, rowappname, rowdoreport, rowdoreview, special_comments, appraiserone, appraisertwo, appasstone, appassttwo, client_db, caprate_db, improved_db, land_db, lease_db, impwordtemplate, daitemplate, daltemplate, dartemplate, adddartemplate, impexceltemplate, landwordtemplate, landexceltemplate, leasewordtemplate, addrentwordtemp, leaseexceltemplate, addrentextemp, miscrent_db, xtrarents, otrenttemplate) VALUES  (:FK_ReportID, :job_no, :bid_fee, :appraisal_type, :purpose_of_appraisal, :client_name, :client_reference_no, :borrower, :estate_appraised, :prosstab_est_app, :proscomp_est_app, :as_is, :prospective_stabilized, :prospective_completion, :retrospective, :eff_date_value, :prosstab_dov, :proscomp_dov, :retro_dov, :inspect_date, :site_valuation, :cost_approach, :income_approach, :groundlease, :sales_comparison, :ownaddress, :owncity, :ownstate, :ownzipcode, :rowprojname, :reqinsdate, :rowdold, :rowsfacq, :rowappfirm, :rowappname, :rowdoreport, :rowdoreview, :special_comments, :appraiserone, :appraisertwo, :appasstone, :appassttwo, :client_db, :caprate_db, :improved_db, :land_db, :lease_db, :impwordtemplate, :daitemplate, :daltemplate, :dartemplate, :adddartemplate, :impexceltemplate, :landwordtemplate, :landexceltemplate, :leasewordtemplate, :addrentwordtemp, :leaseexceltemplate, :addrentextemp, :miscrent_db, :xtrarents, :otrenttemplate)");
			}else{
                $stmt = $this->db->prepare("UPDATE ".APPRAISALS_TABLE." SET job_no=:job_no, bid_fee=:bid_fee, appraisal_type=:appraisal_type, purpose_of_appraisal=:purpose_of_appraisal, client_name=:client_name, client_reference_no=:client_reference_no, borrower=:borrower, estate_appraised=:estate_appraised, prosstab_est_app=:prosstab_est_app, proscomp_est_app=:proscomp_est_app, as_is=:as_is, prospective_stabilized=:prospective_stabilized, prospective_completion=:prospective_completion, retrospective=:retrospective, eff_date_value=:eff_date_value, prosstab_dov=:prosstab_dov, proscomp_dov=:proscomp_dov, retro_dov=:retro_dov, inspect_date=:inspect_date, site_valuation=:site_valuation, cost_approach=:cost_approach, income_approach=:income_approach, groundlease=:groundlease, sales_comparison=:sales_comparison, ownaddress=:ownaddress, owncity=:owncity, ownstate=:ownstate, ownzipcode=:ownzipcode, rowprojname=:rowprojname, reqinsdate=:reqinsdate, rowdold=:rowdold, rowsfacq=:rowsfacq, rowappfirm=:rowappfirm, rowappname=:rowappname, rowdoreport=:rowdoreport, rowdoreview=:rowdoreview, special_comments=:special_comments, appraiserone=:appraiserone, appraisertwo=:appraisertwo, appasstone=:appasstone, appassttwo=:appassttwo, client_db=:client_db, caprate_db=:caprate_db, improved_db=:improved_db, land_db=:land_db, lease_db=:lease_db, impwordtemplate=:impwordtemplate, daitemplate=:daitemplate, daltemplate=:daltemplate, dartemplate=:dartemplate, adddartemplate=:adddartemplate, impexceltemplate=:impexceltemplate, landwordtemplate=:landwordtemplate, landexceltemplate=:landexceltemplate, leasewordtemplate=:leasewordtemplate, addrentwordtemp=:addrentwordtemp, leaseexceltemplate=:leaseexceltemplate, addrentextemp=:addrentextemp, miscrent_db=:miscrent_db, xtrarents=:xtrarents, otrenttemplate=:otrenttemplate
            ...
            $stmt->bindValue(':appraiserone',$appraisals->getAppraiserone(),PDO::PARAM_INT);
            $stmt->bindValue(':appraisertwo',$appraisals->getAppraisertwo(),PDO::PARAM_INT);
            $stmt->bindValue(':appasstone',$appraisals->getAppasstone(),PDO::PARAM_INT);
            $stmt->bindValue(':appassttwo',$appraisals->getAppassttwo(),PDO::PARAM_INT);
            ...
            $stmt->bindValue(':adddartemplate',$appraisals->getAdddartemplate(),PDO::PARAM_STR);
            ...
            $stmt->bindValue(':addrentwordtemp',$appraisals->getAddrentwordtemp(),PDO::PARAM_STR);
            $stmt->bindValue(':addrentextemp',$appraisals->getAddrentextemp(),PDO::PARAM_STR);
            $stmt->bindValue(':miscrent_db',$appraisals->getMiscrent_db(),PDO::PARAM_STR);
            $stmt->bindValue(':xtrarents',$appraisals->getXtrarents(),PDO::PARAM_STR);
            ...
            $stmt->bindValue(':utilities',$appraisals->getUtilities(),PDO::PARAM_STR);
