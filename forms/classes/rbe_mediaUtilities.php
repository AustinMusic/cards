...
class rbe_mediaUtilities {
	...
	public function imageTransformations($img, $imgPath, $toWidth, $toHeight, $quality, $suffix='', $target_path='', $mode="resize", $constrain=false){
	...
	public function cropImage($sourceImage,$sourcePath,$startX,$startY,$targetWidth,$targetHeight,$quality,$suffix='',$targetPath=''){
