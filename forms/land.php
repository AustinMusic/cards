...
//        header("location: _landsales.php?id=". $landsales->getId());
		$landSalesDBController = new landSalesDBController();
        $landSalesDBController->db = $db;	
		$landData = $landSalesDBController->getTableRecord($landsales->getId());
		
		$_GET['id'] = $landsales->getId();
	}
}
...
require("templates/templateLand.php");
