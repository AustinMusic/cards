...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('industrialmorow.xlsx');
$ids = $_GET['id'];
$job = $_GET['job'];
...
header('Content-Disposition: attachment;filename="Industrial - Blended per SF Mo ROW Leases.xlsx"');
