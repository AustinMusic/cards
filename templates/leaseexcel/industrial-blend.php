...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('industrial-blend-mo.xlsx');
$ids = $_GET['id'];
$job = $_GET['job'];
...
header('Content-Disposition: attachment;filename="Industrial - Blended per SF Mo Leases.xlsx"');
