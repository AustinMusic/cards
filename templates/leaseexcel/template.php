	...
	if ( $result->num_rows > 0 ) {
		...
		while ( $record = $result->fetch_object() ) {
			$spreadsheet->getActiveSheet()
				...
				->setCellValueByColumnAndRow($column, 91, $record->eff_rent_comment_1)
				...
				->setCellValueByColumnAndRow($column, 99, $record->mc_file_no)
