...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('industrial-blend-yr.xlsx');
$ids = $_GET['id'];
$job = $_GET['job'];
...
header('Content-Disposition: attachment;filename="Industrial - Blended per SF Yr Leases.xlsx"');
