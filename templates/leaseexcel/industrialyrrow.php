...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('industrialyrrow.xlsx');
$ids = $_GET['id'];
$job = $_GET['job'];
...
header('Content-Disposition: attachment;filename="Industrial - Blended per SF Yr ROW Leases.xlsx"');
