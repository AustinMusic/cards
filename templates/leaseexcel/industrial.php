...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('industrial-shell.xlsx');
$ids = $_GET['id'];
$job = $_GET['job'];
...
header('Content-Disposition: attachment;filename="Industrial - Shell SF per Mo Leases.xlsx"');
