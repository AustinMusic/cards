...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('singlerow.xlsx');
$ids = $_GET['id'];
$job = $_GET['job'];
...
header('Content-Disposition: attachment;filename="Commercial Single Tenant ROW Leases.xlsx"');
