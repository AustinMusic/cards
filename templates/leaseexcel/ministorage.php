...
if ( $result = $conn->query( "SELECT a.id, b.property_name, CONCAT(b.streetnumber,' ',b.streetname) as address, b.city, b.state, c.year_built, c.last_renovation, e.lease_comment, e.confirm_1_source, e.relationship_1, CONCAT(ai.firstname,IF(ai.midname = '',' ',CONCAT(' ',ai.midname,' ')),ai.lastname, IF(ai.designation = '','',CONCAT(', ',ai.designation))) as confirm_by, e.confirm_date, e.mc_file_no, d.ms_total_units, d.ms_pct_vacant_unit, d.ms_vacancy_comment, d.ms_size_1, d.ms_size_2, d.ms_size_3, d.ms_size_4, d.ms_size_5, d.ms_size_6, d.ms_size_7, d.ms_size_8, d.ms_size_9, d.ms_size_10, d.ms_size_11, d.ms_size_12, d.ms_size_13, d.ms_size_14, d.ms_size_15, d.ms_size_16, d.ms_size_17, d.ms_size_18, d.ms_size_19, d.ms_size_20, d.ms_rent_1, d.ms_rent_2, d.ms_rent_3, d.ms_rent_4, d.ms_rent_5, d.ms_rent_6, d.ms_rent_7, d.ms_rent_8, d.ms_rent_9, d.ms_rent_10, d.ms_rent_11, d.ms_rent_12, d.ms_rent_13, d.ms_rent_14, d.ms_rent_15, d.ms_rent_16, d.ms_rent_17, d.ms_rent_18, d.ms_rent_19, d.ms_rent_20, d.ms_coded_access, d.ms_alarm, d.ms_heated_unit, d.ms_onsite_mgr, d.ms_concessions, d.ms_rent_sf_1, d.ms_rent_sf_2, d.ms_rent_sf_3, d.ms_rent_sf_4, d.ms_rent_sf_5, d.ms_rent_sf_6, d.ms_rent_sf_7, d.ms_rent_sf_8, d.ms_rent_sf_9, d.ms_rent_sf_10, d.ms_rent_sf_11, d.ms_rent_sf_12, d.ms_rent_sf_13, d.ms_rent_sf_14, d.ms_rent_sf_15, d.ms_rent_sf_16, d.ms_rent_sf_17, d.ms_rent_sf_18, d.ms_rent_sf_19, d.ms_rent_sf_20
FROM report a
...
WHERE a.id in (".implode(',',(array)$ids).") order by FIELD (a.id,".$ids.")" ) ) {
	...
	$spreadsheet->getActiveSheet()->setCellValue('U115', $job);
...
->setCellValueByColumnAndRow($column, 130, $record->ms_rent_sf_1)
->setCellValueByColumnAndRow($column, 131, $record->ms_rent_sf_2)
->setCellValueByColumnAndRow($column, 132, $record->ms_rent_sf_3)
->setCellValueByColumnAndRow($column, 133, $record->ms_rent_sf_4)
->setCellValueByColumnAndRow($column, 134, $record->ms_rent_sf_5)
->setCellValueByColumnAndRow($column, 135, $record->ms_rent_sf_6)
->setCellValueByColumnAndRow($column, 136, $record->ms_rent_sf_7)
->setCellValueByColumnAndRow($column, 137, $record->ms_rent_sf_8)
->setCellValueByColumnAndRow($column, 138, $record->ms_rent_sf_9)
->setCellValueByColumnAndRow($column, 139, $record->ms_rent_sf_10)
->setCellValueByColumnAndRow($column, 140, $record->ms_rent_sf_11)
->setCellValueByColumnAndRow($column, 141, $record->ms_rent_sf_12)
->setCellValueByColumnAndRow($column, 142, $record->ms_rent_sf_13)
->setCellValueByColumnAndRow($column, 143, $record->ms_rent_sf_14)
->setCellValueByColumnAndRow($column, 144, $record->ms_rent_sf_15)
->setCellValueByColumnAndRow($column, 145, $record->ms_rent_sf_16)
->setCellValueByColumnAndRow($column, 146, $record->ms_rent_sf_17)
->setCellValueByColumnAndRow($column, 147, $record->ms_rent_sf_18)
->setCellValueByColumnAndRow($column, 148, $record->ms_rent_sf_19)
->setCellValueByColumnAndRow($column, 149, $record->ms_rent_sf_20)
...
header('Content-Disposition: attachment;filename="Mini-Storage Leases.xlsx"');
