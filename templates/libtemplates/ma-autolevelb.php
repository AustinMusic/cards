...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/ma-autolevelb.docx' );
...
header( "Content-Disposition: attachment; filename=Market Overview - Auto Dealership- Level B.docx" );
