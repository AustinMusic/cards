...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/recprosatcomplease.docx' );
...
header( "Content-Disposition: attachment; filename=Reconcliation - Prospective Stablized At Completion As Is - Leased Fee.docx" );
readfile( $temp_file );
unlink( $temp_file );
