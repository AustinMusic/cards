...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idrestsit.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Restaurant Sit-Down.docx" );
