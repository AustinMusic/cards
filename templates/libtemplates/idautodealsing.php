...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idautodealsing.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Auto Dealership Single-Brand.docx" );
