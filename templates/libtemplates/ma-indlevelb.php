...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/ma-indlevelb.docx' );
...
header( "Content-Disposition: attachment; filename=Market Overview - Industrial - Level B.docx" );
