...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/vmasis.docx' );
...
header( "Content-Disposition: attachment; filename=Valuation Methodogy - As Is.docx" );
