...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/regmedash.docx' );
...
header( "Content-Disposition: attachment; filename=Regional - Medford-Ashland MSA.docx" );
