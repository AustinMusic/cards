...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( "../../app_images/" . $_GET['app'] . "/qualifications.docx" );
...
header( "Content-Disposition: attachment; filename=Appraiser%20Qualifications.docx" );
