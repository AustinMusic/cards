...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/iddaycare.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Daycare Preschool.docx" );
