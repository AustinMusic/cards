...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idautodealmulti.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Auto Dealership Multi-Brand.docx" );
