...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/recprosatcompasis.docx' );
...
header( "Content-Disposition: attachment; filename=Reconcliation - Prospective At Completion As Is - Fee Simple.docx" );
readfile( $temp_file );
unlink( $temp_file );
