...
$templatePath = dirname(__FILE__).'/../output/libtemps/ORassvalMulti.docx';
$outputFilename = 'OR Assessed Values and Property Taxes.docx';
...
//second
if ($result = $conn->query("
SELECT parcelno, marketland as landval, marketimp as impval, markettotal as totalval, measure50 as meas50, annualtaxes as taxes
from assessedvalues
where FK_ReportID = " . $_GET['id'])) {
	...
	while($record = $result->fetch_object()) {
		$values[] = [
						...
						'meas50' => '$'.number_format($record->meas50),
	...
	$templateProcessor->setValue('summeas', '$'.number_format($summeas));
