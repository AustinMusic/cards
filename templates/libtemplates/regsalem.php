...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/regsalem.docx' );
...
header( "Content-Disposition: attachment; filename=Regional - Salem MSA..docx" );
