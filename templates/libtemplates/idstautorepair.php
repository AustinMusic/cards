...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idstautorepair.docx' );
  ...
  while ( $record = $result->fetch_object() ) {
    ...
    $templateProcessor->setValue( 'floor1', $record->floor1 );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Single Tenant Auto Repair.docx" );
