...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/ma-officelevela.docx' );
...
header( "Content-Disposition: attachment; filename=Market Overview - Office - Level A.docx" );
