...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/ma-retaillevela.docx' );
...
header( "Content-Disposition: attachment; filename=Market Overview - Retail - Level A.docx" );
