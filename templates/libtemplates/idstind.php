...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idstind.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Single-Tenant Indust.docx" );
