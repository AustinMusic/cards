...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idstoff.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Single-Tenant Office.docx" );
