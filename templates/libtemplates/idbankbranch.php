...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( '../output/libtemps/idbankbranch.docx' );
...
header( "Content-Disposition: attachment; filename=Improv Descrip - Bank Branch.docx" );
