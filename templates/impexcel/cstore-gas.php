...
$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'cstore-gas.xlsx' );
...
header( 'Content-Disposition: attachment;filename="C-store Gas Station Improved Sales.xlsx"' );
