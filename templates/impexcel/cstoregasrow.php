...
$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'cstoregasrow.xlsx' );
...
header( 'Content-Disposition: attachment;filename="C-store Gas Station ROW Improved Sales.xlsx"' );
