...
$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'dealershiprow.xlsx' );
  ...
  if ( $result->num_rows > 0 ) {
    ...
    while ( $record = $result->fetch_object() ) {
      $spreadsheet->getActiveSheet()
		  ...
		  ->setCellValueByColumnAndRow( $column, 265, "'" . $record->mc_file_no )
...
header( 'Content-Disposition: attachment;filename="Dealership ROW Improved Sales.xlsx"' );
