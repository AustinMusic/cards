...
$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'commsinglerow.xlsx' );
    ...
    if ( $result->num_rows > 0 ) {
        ...
        while ( $record = $result->fetch_object() ) {
            $spreadsheet->getActiveSheet()
				...
				->setCellValueByColumnAndRow( $column, 251, "'" . $record->mc_file_no )
...
header( 'Content-Disposition: attachment;filename="Commercial Single Tenant ROW Improved Sales.xlsx"' );
