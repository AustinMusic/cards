...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('comm-multi.xlsx');
...
header('Content-Disposition: attachment;filename="Commercial Multi Tenant Improved Sales.xlsx"');
