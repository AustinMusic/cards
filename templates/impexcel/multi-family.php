...
$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'multi-family.xlsx' );
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
      ...
      $spreadsheet->getActiveSheet()->setCellValue( 'E29', $subprop->nounits );
	  ...
	  $spreadsheet->getActiveSheet()->setCellValue( 'E76', $subprop->pratiounit);
...
header( 'Content-Disposition: attachment;filename="Multi-Family Improved Sales.xlsx"' );
