<?php
require '../src/vendor/autoload.php';$ids = $_GET[ 'id' ];

use PhpOffice\ PhpSpreadsheet\ Spreadsheet;
use PhpOffice\ PhpSpreadsheet\ Writer\ Xlsx;

$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'veh_dealership.xlsx' );
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
	  ...
	  $spreadsheet->getActiveSheet()->setCellValue( 'W193', $subprop->effdov );
  ...
  if ( $result->num_rows > 0 ) {
    ...
    while ( $record = $result->fetch_object() ) {
      $spreadsheet->getActiveSheet()
		  ...
		  ->setCellValueByColumnAndRow( $column, 235, "'" . $record->mc_file_no )
...
$spreadsheet->getActiveSheet()->getRowDimension( '86' )->setRowHeight( -1 );
...
$spreadsheet->getActiveSheet()->getRowDimension( '195' )->setRowHeight( -1 );
$spreadsheet->getActiveSheet()->getRowDimension( '196' )->setRowHeight( -1 );

$spreadsheet->getActiveSheet()->getStyle( 'G130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'H130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'I130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'J130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'K130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'L130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'M130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'N130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'O130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'P130' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'G131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'H131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'I131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'J131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'K131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'L131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'M131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'N131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'O131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'P131' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_TEXT );
$spreadsheet->getActiveSheet()->getStyle( 'W193' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_DATE_XLSX14 );
...
header( 'Content-Disposition: attachment;filename="Dealership Improved Sales.xlsx"' );
