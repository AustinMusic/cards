...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('shoppingrow.xlsx');
...
header('Content-Disposition: attachment;filename="Shopping Center ROW Improved Sales.xlsx"');
