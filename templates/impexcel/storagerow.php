...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('storagerow.xlsx');
...
header('Content-Disposition: attachment;filename="Mini-Storage ROW Improved Sales.xlsx"');
