...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('storage.xlsx');
...
if ( $result->num_rows > 0 ) {
	...
	while ( $record = $result->fetch_object() ) {
		$spreadsheet->getActiveSheet()
			...
			->setCellValueByColumnAndRow($column, 29, $record->total_storage_units)
...
header('Content-Disposition: attachment;filename="Mini-Storage Improved Sales.xlsx"');
