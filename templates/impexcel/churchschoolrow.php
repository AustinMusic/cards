...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('churchschoolrow.xlsx');
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
	  ...
	  $spreadsheet->getActiveSheet()->setCellValue( 'E142', "'" . $subprop->yearbt );
	  $spreadsheet->getActiveSheet()->setCellValue( 'E143', $subprop->reno );		
...
if ( $result->num_rows > 0 ) {
	...
	while ( $record = $result->fetch_object() ) {
		...
		->setCellValueByColumnAndRow($column, 140, $record->city)
		->setCellValueByColumnAndRow($column, 141, $record->state)
		...
		->setCellValueByColumnAndRow($column, 142, "'" . $record->year_built)
		->setCellValueByColumnAndRow($column, 143, $record->last_renovation)
		...
		->setCellValueByColumnAndRow($column, 151, $record->no_single_wide)
		->setCellValueByColumnAndRow($column, 152, $record->no_double_wide)
		->setCellValueByColumnAndRow($column, 153, $record->no_triple_wide)
		->setCellValueByColumnAndRow($column, 154, $record->no_rv_space)
		...
		->setCellValueByColumnAndRow($column, 186, $record->floor_1_gba)
		...
		->setCellValueByColumnAndRow($column, 144, $record->ind_truck_grade)
		->setCellValueByColumnAndRow($column, 145, $record->ind_truck_dock)
		...
		->setCellValueByColumnAndRow($column, 92, $record->replace_cost)
		->setCellValueByColumnAndRow($column, 93, $record->est_rcn)
		->setCellValueByColumnAndRow($column, 95, $record->less_alloc_imp_price)
		->setCellValueByColumnAndRow($column, 98, $record->eff_age_years)
		->setCellValueByColumnAndRow($column, 103, $record->oe_pgi)
		->setCellValueByColumnAndRow($column, 105, $record->oe_vacancy_credit_loss)
		->setCellValueByColumnAndRow($column, 106, $record->oe_other_income)
		->setCellValueByColumnAndRow($column, 109, $record->oe_expences)
		->setCellValueByColumnAndRow($column, 110, $record->oe_total_noi)
		->setCellValueByColumnAndRow($column, 115, $record->oe_vacany_pct)                              
		->setCellValueByColumnAndRow($column, 138, $record->store_sales_mult)
		->setCellValueByColumnAndRow($column, 158, $record->confirm_1_source)
		->setCellValueByColumnAndRow($column, 159, $record->relationship_1)
		->setCellValueByColumnAndRow($column, 160, $record->confirm_by)
		->setCellValueByColumnAndRow($column, 161, $record->confirm_date)
		->setCellValueByColumnAndRow($column, 263, "'" . $record->mc_file_no)
		->setCellValueByColumnAndRow($column, 164, $record->sale_comments)
		->setCellValueByColumnAndRow($column, 185, $record->underlying_land_value_primary);
		$column++;
	}
} else {
...
$spreadsheet->getActiveSheet()->getRowDimension('60')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('68')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('80')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('158')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('159')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('164')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('199')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('200')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('224')->setRowHeight(-1);

$spreadsheet->getActiveSheet()->getStyle('W197')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
...
$spreadsheet->getActiveSheet()->getStyle('G161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('H161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('I161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('J161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('K161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('L161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('M161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('N161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('O161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('P161')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);

// close database connection
$conn->close();
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="Church - School ROW Improved Sales.xlsx"');
