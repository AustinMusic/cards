...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('commmultirow.xlsx');
...
header('Content-Disposition: attachment;filename="Commercial Multi Tenant ROW Improved Sales.xlsx"');
