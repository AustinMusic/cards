...
$spreadsheet = \PhpOffice\ PhpSpreadsheet\ IOFactory::load( 'servicerow.xlsx' );
...
header( 'Content-Disposition: attachment;filename="Service - Repair ROW Improved Sales.xlsx"' );
