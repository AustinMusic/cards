...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'caoffprop.docx' );
...
header( "Content-Disposition: attachment; filename=Cost Approach - Office Proposed.docx" );
