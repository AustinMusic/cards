...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('mvsorkbookomb.xlsx');
...
$spreadsheet->getSheet(0)->setCellValue('C48', $primary . " SF X");
...
header('Content-Disposition: attachment;filename="MVS Workbook - Office Medical Bank.xlsx"');
