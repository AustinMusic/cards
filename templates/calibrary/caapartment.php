...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'caapartment.docx' );
...
header( "Content-Disposition: attachment; filename=Cost Approach - Apartment Proposed.docx" );
