...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'cacommprop.docx' );
...
header( "Content-Disposition: attachment; filename=Cost Approach - Commercial Proposed.docx" );
