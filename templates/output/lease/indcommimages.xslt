...
<w:trPr>
         ...
         <xsl:when test="position()=1">
                    <w:t>Lease Comparable <xsl:value-of select="position()"/><w:b /></w:t>
         </xsl:when>
         <xsl:otherwise>
                    <w:t>Lease Comparable <xsl:value-of select="2*position()-1"/><w:b /></w:t>
         </xsl:otherwise>
       </xsl:choose>
       <w:br/>
       </w:r>
                  ...
                  <w:pPr>
                    ...
                    <w:rPr>
                      ...
                      <w:b w:val="true" />
                                   ...
                                   <xsl:choose>
         <xsl:when test="position()=1">
                    <w:t>Lease Comparable <xsl:value-of select="position()+1"/></w:t>
         </xsl:when>
         <xsl:otherwise>
			 <xsl:if test="following::row[ceiling($size div 2)]/city!=''">
                    <w:t>Lease Comparable <xsl:value-of select="2*position()"/></w:t>
                    </xsl:if>
         </xsl:otherwise>
       </xsl:choose>
       <w:br/>
