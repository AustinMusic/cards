                        ...
                        <w:r w:rsidRPr="0004412A">
                          ...
                          <xsl:choose>
                            <xsl:when test="position()=1">
                              <w:t>Rent Comp <xsl:value-of select="position()"/>
                                <w:b />
                              </w:t>
                            </xsl:when>
                            <xsl:otherwise>
                              <w:t>Rent Comp <xsl:value-of select="2*position()-1"/>
                                <w:b />
                              </w:t>
                            </xsl:otherwise>
                          </xsl:choose>
                      ...
                      <w:p w:rsidR="003346C6" w:rsidRPr="005F3377" w:rsidRDefault="003346C6" w:rsidP="003346C6">
                        ...
                        <w:r>
						  ...
						  <xsl:choose>
                              ...
                              <xsl:otherwise> 
								    <w:t><xsl:value-of select="following::row[$imageid - 2]/address"/></w:t>
									<w:t xml:space="preserve">, </w:t>
									<w:t><xsl:value-of select="following::row[$imageid - 2]/city"/></w:t>   
                              </xsl:otherwise>
                            </xsl:choose>
                      ...
                      <w:tc>
                        ...
                        <w:p w:rsidR="003346C6" w:rsidRDefault="003346C6" w:rsidP="003346C6">
                          ...
                          <w:r>
                            ...
                            <xsl:choose>
                              <xsl:when test="position()=1">
                                <w:t>Rent Comp <xsl:value-of select="position()+1"/></w:t>
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:if test="following::row[ceiling($size div 2)]/city!=''">
                                  <w:t>Rent Comp <xsl:value-of select="2*position()"/></w:t>
                                </xsl:if>
                              </xsl:otherwise>
                            </xsl:choose>
                          </w:r>
                        ...
                        <w:p w:rsidR="003346C6" w:rsidRPr="005F3377" w:rsidRDefault="003346C6" w:rsidP="003346C6">
                          ...
                          <w:r>
							...
							<xsl:choose>
                              <xsl:when test="position()=1">
								<w:t><xsl:value-of select="following::row[$imageid - 1]/address"/></w:t>
								<w:t xml:space="preserve">, </w:t>
								<w:t><xsl:value-of select="following::row[$imageid  - 1]/city"/></w:t> 
                              </xsl:when>
