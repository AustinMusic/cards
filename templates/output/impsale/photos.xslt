                        ...
                        <w:r w:rsidRPr="0004412A">
                          ...
                          <xsl:choose>
                            <xsl:when test="position()=1">
                              <w:t>Improved <xsl:value-of select="saletype"/> <xsl:value-of select="position()"/>
                                <w:b />
                              </w:t>
                            </xsl:when>
                            <xsl:otherwise>
                              <w:t>Improved <xsl:value-of select="following::row[$imageid - 2]/saletype"/> <xsl:value-of select="2*position()-1"/>
                                <w:b />
                              </w:t>
                            </xsl:otherwise>
                          </xsl:choose>
