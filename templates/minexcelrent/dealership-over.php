...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('dealership-over.xlsx');
$ids = $_GET['id'];
	...
	if ( $result->num_rows > 0 ) {
		...
		while ( $record = $result->fetch_object() ) {
			$spreadsheet->getActiveSheet()
				...
				->setCellValueByColumnAndRow($column, 147, "'" . $record->mc_file_no)
...
header('Content-Disposition: attachment;filename="Dealership-Overall.xlsx"');
