...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('industrial-blend.xlsx');
$ids = $_GET['id'];
	...
	if ( $result->num_rows > 0 ) {
		...
		while ( $record = $result->fetch_object() ) {
			$spreadsheet->getActiveSheet()
				...
				->setCellValueByColumnAndRow($column, 89, $record->eff_rent_comment_1)
				...
				->setCellValueByColumnAndRow($column, 90, $record->eff_rent_comment_2)
...
header('Content-Disposition: attachment;filename="Industrial - Blended.xlsx"');
