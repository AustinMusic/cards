...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('aamtarco.xlsx');
...
header('Content-Disposition: attachment;filename="Absorption Analysis-Annual Rent-Current Occupancy.xlsx"');
