...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'offmtmodgross.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Office Multi-Tenant - Modified Gross.docx" );
