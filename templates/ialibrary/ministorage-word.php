...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'ministorage.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Mini Storage.docx" );
