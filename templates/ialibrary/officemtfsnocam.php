...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('offmtnnnnocam.xlsx');
...
header('Content-Disposition: attachment;filename="Office_Multi-Tenant_NNN_noCAMReimb.xlsx"');
