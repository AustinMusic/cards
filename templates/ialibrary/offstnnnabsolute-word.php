...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'offstnnnabsolute.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Office Single-Tenant - NNN Absolute.docx" );
