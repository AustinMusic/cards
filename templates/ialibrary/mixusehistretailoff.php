...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('muhistro.xlsx');
...
header('Content-Disposition: attachment;filename="MixedUse_Historic_Retail_and_Office.xlsx"');
