...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'muretailoffice.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Mixed Use - Retail Office.docx" );
