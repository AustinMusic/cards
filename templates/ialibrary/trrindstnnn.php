...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('trristnnn.xlsx');
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
		$spreadsheet->getActiveSheet()->setCellValue('aa3', $subprop->effdov);
...
header('Content-Disposition: attachment;filename="Tenant_Rent_Roll_Industrial_Single-Tenant_NNN.xlsx"');
