...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'trrindstnnn.docx' );
...
header( "Content-Disposition: attachment; filename=Industrial Single-Tenant - NNN.docx" );
