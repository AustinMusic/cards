...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'offstnnn.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Office Single-Tenant - NNN.docx" );
