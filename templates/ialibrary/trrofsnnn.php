...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('trrofsnnn.xlsx');
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
		$spreadsheet->getActiveSheet()->setCellValue('aa6', $subprop->effdov);
...
header('Content-Disposition: attachment;filename="Tenant_Rent_Roll_Office_Multi-Tenant_FullService to NNN.xlsx"');
