...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('aamtmrco.xlsx');
...
header('Content-Disposition: attachment;filename="Absorption Analysis-Monthly Rent-Current Occupancy.xlsx"');
