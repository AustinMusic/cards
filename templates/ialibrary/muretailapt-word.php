...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'muretailapt.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Mixed Use - Retail - Apartment.docx" );
