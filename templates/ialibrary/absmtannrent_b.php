...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('aamtarpb.xlsx');
...
header('Content-Disposition: attachment;filename="Absorption Analysis-Annual Rent-Proposed Building.xlsx"');
