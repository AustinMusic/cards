...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'commstnnnabsolute.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Comm Single Tenant - NNN Absolute.docx" );
