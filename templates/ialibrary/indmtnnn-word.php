...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'indmtnnn.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Industrial Multi-Tenant - NNN Typical.docx" );
