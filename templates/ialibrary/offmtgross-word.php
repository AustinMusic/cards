...
where a.id = " . $_GET['id'] . "" ) ) {
  ...
  $templateProcessor = new\ PhpOffice\ PhpWord\ TemplateProcessor( 'offmtgross.docx' );
...
header( "Content-Disposition: attachment; filename=Income Approach - Office Multi Tenant Gross.docx" );
