<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/evalsalecompinctwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/evalsalecompincone.docx';
}
$outputFilename = 'Evaluation Report - Sales Comp and Income.docx';
