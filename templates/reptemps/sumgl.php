<?php
if ($_GET['apptwo'] !=''){
$templatePath = dirname(__FILE__).'/sumgltwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/sumglone.docx';
}
$outputFilename = 'Summary Form - Ground Lease Valuation.docx';
