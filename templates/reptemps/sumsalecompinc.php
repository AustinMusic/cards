<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/sumsalecompinctwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/sumsalecompincone.docx';
}
$outputFilename = 'Summary Form - Sales Comp and Income.docx';
