<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/sumlandvaltwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/sumlandvalone.docx';
}
$outputFilename = 'Summary Form - Land Valuation.docx';
