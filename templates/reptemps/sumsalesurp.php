<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/sumsalesurptwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/sumsalesurpone.docx';
}
$outputFilename = 'Summary Form - Sales Comp with Surplus Land.docx';
...
join subtype p on p.id = b.propertysubtype
WHERE a.id = " . $_GET['id'] . "")) {
