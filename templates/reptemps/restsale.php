<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/restsaletwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/restsaleone.docx';
}
$outputFilename = 'Restricted Report - Form - Sales Comp Approach.docx';
