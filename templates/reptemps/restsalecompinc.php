<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/restsalecompinctwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/restsalecompincone.docx';
}
$outputFilename = 'Restricted Report - Form - Sales Comp and Income Approach.docx';
