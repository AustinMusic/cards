<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/evalsalesurptwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/evalsalesurpone.docx';
}
$outputFilename = 'Evaluation Report - Sales with Surplus Land.docx';
