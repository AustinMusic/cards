<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/restlandvaltwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/restlandvalone.docx';
}
$outputFilename = 'Restricted Report - Form - Land Valuation.docx';
