<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/sumrentstudycommertwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/sumrentstudycommerone.docx';
}
$outputFilename = 'Rent Study - Commercial.docx';
