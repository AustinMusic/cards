<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/evallandvaltwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/evallandvalone.docx';
}
$outputFilename = 'Evaluation Report - Land Valuation.docx';
