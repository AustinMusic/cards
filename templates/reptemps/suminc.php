<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/suminctwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/sumincone.docx';
}
$outputFilename = 'Summary Form - Income  Only.docx';
