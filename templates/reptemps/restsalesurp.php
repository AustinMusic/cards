<?php
if ($_GET['apptwo'] !=''){
    $templatePath = dirname(__FILE__).'/restsalesurptwo.docx';
    } else {
    $templatePath = dirname(__FILE__).'/restsalesurpone.docx';
}
$outputFilename = 'Restricted Report - Form - Sales Comp with Surplus Land Approach.docx';
