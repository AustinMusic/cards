...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('reshomerow.xlsx');
...
header('Content-Disposition: attachment;filename="Residential Homesite ROW Land Sales.xlsx"');
