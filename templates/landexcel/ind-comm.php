...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('ind-comm.xlsx');
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
		...
		$spreadsheet->getActiveSheet()->setCellValue('E158', $subprop->submarket);
		...
		$spreadsheet->getActiveSheet()->setCellValue('E148', $subprop->estapp);
	}
}
...
header('Content-Disposition: attachment;filename="Industrial - Commercial Land Sales.xlsx"');
