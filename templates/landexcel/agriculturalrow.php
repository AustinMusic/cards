...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('agriculturalrow.xlsx');
...
if ( $result->num_rows > 0 ) {
	...
	while ( $record = $result->fetch_object() ) {
		...
		->setCellValueByColumnAndRow($column, 29, $record->nohomesite)
		...
		->setCellValueByColumnAndRow($column, 42, $record->soiltype)
		...
		->setCellValueByColumnAndRow($column, 43, $record->irigwell)
...
header('Content-Disposition: attachment;filename="Agrigultural ROW Land Sales.xlsx"');
