...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('sfresrow.xlsx');
...
$spreadsheet->getActiveSheet()->getRowDimension('57')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('58')->setRowHeight(-1);
...
header('Content-Disposition: attachment;filename="Single Family - Residential ROW Land Sales.xlsx"');
