...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('mfresrow.xlsx');
...
$spreadsheet->getActiveSheet()->getRowDimension('82')->setRowHeight(-1);
...
header('Content-Disposition: attachment;filename="Multi-family Residential Land Sales.xlsx"');
