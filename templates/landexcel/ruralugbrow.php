...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('ruralugbrow.xlsx');
...
header('Content-Disposition: attachment;filename="Agriculture - Rural - UGB ROW Land Sales.xlsx"');
