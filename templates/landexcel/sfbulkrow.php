...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('sfbulkrow.xlsx');
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
		...
		$spreadsheet->getActiveSheet()->setCellValue('E151', $subprop->estapp);
	}
}
...
$spreadsheet->getActiveSheet()->getRowDimension('83')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('90')->setRowHeight(-1);
...
header('Content-Disposition: attachment;filename="Single Family Bulk Lot ROW Land Sales.xlsx"');
