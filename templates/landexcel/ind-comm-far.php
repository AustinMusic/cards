...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('ind-comm-far.xlsx');
...
if ( $result->num_rows > 0 ) {
	while ( $subprop = $result->fetch_object() ) {
		...
		$spreadsheet->getActiveSheet()->setCellValue('E42', $subprop->orientation);
...
WHERE a.id in (".implode(',',(array)$ids).") order by FIELD (a.id,".$ids.")" ) ) {
	if ( $result->num_rows > 0 ) {
		...
		while ( $record = $result->fetch_object() ) {
			...
			->setCellValueByColumnAndRow($column, 110, $record->city)
			->setCellValueByColumnAndRow($column, 111, $record->state)
			...
			->setCellValueByColumnAndRow($column, 35, $record->floor_area_ratio)
			...
			->setCellValueByColumnAndRow($column, 47, $record->traffic_count)
			->setCellValueByColumnAndRow($column, 48, $record->easement_desc)
			->setCellValueByColumnAndRow($column, 51, $record->rural_electricity)
			->setCellValueByColumnAndRow($column, 52, $record->municiple_water)
			->setCellValueByColumnAndRow($column, 53, $record->municiple_sewer)
			->setCellValueByColumnAndRow($column, 54, $record->well_septic)
			->setCellValueByColumnAndRow($column, 58, $record->grantor)
			->setCellValueByColumnAndRow($column, 59, $record->grantee)
			->setCellValueByColumnAndRow($column, 61, $record->record_date)
			->setCellValueByColumnAndRow($column, 62, $record->record_date_two)
			->setCellValueByColumnAndRow($column, 63, $record->sale_status)
			->setCellValueByColumnAndRow($column, 64, $record->sale_price)
			->setCellValueByColumnAndRow($column, 65, $record->eff_sale_price_stab)
			->setCellValueByColumnAndRow($column, 66, $record->adj_price_comment)
			->setCellValueByColumnAndRow($column, 67, $record->market_time)
			->setCellValueByColumnAndRow($column, 68, $record->inc_entitlement)
			->setCellValueByColumnAndRow($column, 69, $record->value_entitle)
			->setCellValueByColumnAndRow($column, 72, $record->gl_length)
			->setCellValueByColumnAndRow($column, 73, $record->gl_options_period)
			->setCellValueByColumnAndRow($column, 74, $record->gl_rent_begin)
			->setCellValueByColumnAndRow($column, 75, $record->gl_escalations)
			->setCellValueByColumnAndRow($column, 76, $record->gl_rent_per_sf_land)
			->setCellValueByColumnAndRow($column, 77, $record->gl_rent_per_sf_footprint)
			->setCellValueByColumnAndRow($column, 78, $record->gl_rate_return)
			->setCellValueByColumnAndRow($column, 82, $record->no_lots)
			->setCellValueByColumnAndRow($column, 83, $record->type_residential_land)
			->setCellValueByColumnAndRow($column, 84, $record->unit_lot_type)                              
			->setCellValueByColumnAndRow($column, 86, $record->fut_finish_size_avg)
			->setCellValueByColumnAndRow($column, 87, $record->lot_complete_date)
			->setCellValueByColumnAndRow($column, 88, $record->finish_lot_size_range)
			->setCellValueByColumnAndRow($column, 89, $record->fut_finish_size_avg)
			->setCellValueByColumnAndRow($column, 90, $record->lot_topography)
			->setCellValueByColumnAndRow($column, 91, $record->project_amenities)
			->setCellValueByColumnAndRow($column, 94, $record->fut_avg_home_price)
			->setCellValueByColumnAndRow($column, 95, $record->lot_home_price_ratio)
			->setCellValueByColumnAndRow($column, 96, $record->report_price_lot)
			->setCellValueByColumnAndRow($column, 97, $record->ind_sale_pct_discount)                                
			->setCellValueByColumnAndRow($column, 122, $record->confirm_1_source)
			->setCellValueByColumnAndRow($column, 123, $record->relationship_1)
			->setCellValueByColumnAndRow($column, 124, $record->confirm_by)
			->setCellValueByColumnAndRow($column, 125, $record->confirm_date)
			->setCellValueByColumnAndRow($column, 180, "'" . $record->mc_file_no)
			->setCellValueByColumnAndRow($column, 128, $record->sale_comments);
			$column++;
		}
	} else {
...
$spreadsheet->getActiveSheet()->getRowDimension('63')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('66')->setRowHeight(-1);
...
$spreadsheet->getActiveSheet()->getRowDimension('126')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('128')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('138')->setRowHeight(-1);
$spreadsheet->getActiveSheet()->getRowDimension('139')->setRowHeight(-1);

$spreadsheet->getActiveSheet()->getStyle('W136')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle( 'E64' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_CURRENCY_USD );
$spreadsheet->getActiveSheet()->getStyle( 'E61' )->getNumberFormat()->setFormatCode( \PhpOffice\ PhpSpreadsheet\ Style\ NumberFormat::FORMAT_DATE_XLSX17 );
$spreadsheet->getActiveSheet()->getStyle('G61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('H61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('I61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('J61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('K61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('L61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('M61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('N61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('O61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('P61')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX17);
$spreadsheet->getActiveSheet()->getStyle('G125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('H125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('I125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('J125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('K125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('L125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('M125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('N125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('O125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
$spreadsheet->getActiveSheet()->getStyle('P125')->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_DATE_XLSX14);
// close database connection
$conn->close();
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="Industrial - Commercial - FAR Land Sales.xlsx"');
