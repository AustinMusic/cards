...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('sfres.xlsx');
...
header('Content-Disposition: attachment;filename="Single Family - Residential Land Sales.xlsx"');
